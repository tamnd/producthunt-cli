...
description: "What changed in each ph release, newest first."
weight: 40
---
...
- [v0.2.0](/release-notes/v0-2-0/) is the current release: the full two-plane rebuild on the any-cli/kit framework.
