...
Most of these come down to network reality or how producthunt serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

producthunt rate-limits like any public site. ph already paces
...
Where a surface is gated, ph reads a cookie or token you supply
